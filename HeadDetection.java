 ...
 * @author IsraelRuelas
 */
public class HeadDetection extends EventFilter2D implements FrameAnnotater 
{   
    ...
    public HeadDetection(AEChip chip)
    {
        super(chip);
    }
    ...
    protected int MinPixelsPerGroup= getPrefs().getInt("HeadDetection.MinPixelsPerGroup",7);
    {
    ...
    {
        getPrefs().putInt("HeadDetection.MinPixelsPerGroup", MinPixelsPerGroup);
    ...
    protected int MinDistanceBetweenPoints= getPrefs().getInt("HeadDetection.MinDistanceBetweenPoints",4);
    {
